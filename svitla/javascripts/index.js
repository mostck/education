$(function() {
  ...
  var pages = [
    ...
    { id: 4, title: "contact", content: '<div class="row"><div class="col-md-12 col-sm-12"><div class="mainWrapSubTitle textCenter"><h1 class="mainSubTitle">Get in Touch</h1><p class="mainSubText">We’re currently accepting new client projects. We look forward to serving you.</p></div></div></div><div class="row"><div class="col-lg-8 col-sm-6 col-sx-12"><div id="mapholder" class="formWrap"></div></div><div class="col-lg-4 col-sm-6 col-sx-12"><div class="rightContentWrap"><p class="mainSubText">Contact Details</p><a href="#"><p>info@svitla.com</p></a><p>650-917-9544</p><p><span class="bold">Svitla Systems, Inc.</span><br />1501 Howard Street,<br />San Francisco, California 94103<br />USA</p></div></div></div><div class="separators formWrap"></div><div class="row"><div class="col-lg-8 col-sm-12 col-sx-12"><form class="formWrap" name="form" method="post"><div class="row"><div class="col-sm-6 col-sx-12"><div class="inputTextWrap inputTextLeftWrap"><input class="widthResize inputText" type="text" placeholder="Full Name" name="name"></div></div><div class="col-sm-6 col-sx-12"><div class="inputTextWrap inputTextRightWrap"><input class="widthResize inputText" type="text" placeholder="Email Address" name="email"></div></div></div><div class="inputTextWrap"><textarea class="widthResize inputText" name="textarea"></textarea></div><div class="row"><div class="col-sm-3 col-sm-offset-9 col-sx-12"><input class="widthResize btn btnPrime" type="submit" value="Send Message"></div></div></form></div></div>' },
  ];
